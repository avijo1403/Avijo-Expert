...
export default function HeaderItem(props) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: props.blue ? colors.blue : colors.white, }]}>
            ...
            {/* <TouchableOpacity onPress={props.notiPress} style={{marginRight:'3%'}}>
                <View style={styles.numberContainer}>
                    <Text style={styles.number}>7+</Text>
                </View>
                {props.blue ? <Image source={require('../assets/images/chat7.png')} style={{ height: 23, width: 23 }} /> : <Image source={require('../assets/images/chat7.png')} style={{ height: 23, width: 23 }} />}
            </TouchableOpacity> */}
            <TouchableOpacity onPress={props.notiPress}>
                <View style={styles.numberContainer}>
                    <Text style={styles.number}>7+</Text>
                </View>
                {props.blue ? <Image source={require('../assets/images/whiteNoti.png')} style={{ height: 26, width: 24 }} /> : <Image source={require('../assets/images/notification.png')} style={{ height: 30, width: 28 }} />}
            </TouchableOpacity>
        </View>
    )
}
