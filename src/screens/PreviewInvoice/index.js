                ...
                <View style={{ width: '100%', alignItems: 'center', backgroundColor: colors.white, elevation: 5, marginTop: '5%', paddingBottom: '5%' }}>
                    ...
                    <View style={{ width: '92%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: '5%', marginRight: '1%', marginBottom: '5%' }}>
                        <View style={{ width: '52%', alignItems: 'center' }}>
                            <Button2 onPress={() => navigation.navigate('ShareWithPatient')} Text="Share" image={<Image source={require('../../assets/images/blueShare.png')} style={{ height: 20, width: 20, marginLeft: 5 }} />} />
                        </View>
                        <View style={{ width: '52%', alignItems: 'center' }}>
                            <Button2 Text="Download" image={<Image source={require('../../assets/images/blueDownload.png')} style={{ height: 20, width: 20, marginLeft: 5 }} />} />
                        </View>
                    </View>
                    <View style={{ width: '100%', alignItems: 'center', marginTop: '5%' }}>
                        <Button1 Text="Generate to payment" />
                    </View>
                </View>
            </ScrollView>
        </View>
