...
export default function EditAppointment({navigation}) {
  ...
  const handleDateChange = (selectedDate) => {
    ...
    return (
        <View style={styles.container}>
            <HeaderItem3 text="Edit Appointment" onPress={()=>navigation.goBack()} />
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: 'center' }}>
                <View style={{ width: '95%', alignItems: 'flex-end', justifyContent: 'space-between', flexDirection: 'row', marginRight: '5%' }}>
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate('AddAppointment')} style={{ borderWidth: 1, borderColor: colors.blue, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: '4%', borderRadius: 8, borderStyle: "dashed", marginTop: '5%' }}>
