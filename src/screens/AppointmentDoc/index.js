...
export default function AppointmentDoc({ navigation }) {
                ...
                <View style={{ width: '100%', alignItems: 'center' }}>
                    <FlatList
                        ...
                        renderItem={({ item }) => {
                            ...
                            return (
                                <View style={{ width: '90%', alignItems: 'center', borderWidth: 1, padding: 5, borderRadius: 8, borderColor: colors.lightgrey, backgroundColor: colors.white, elevation: 5, marginTop: '5%', }}>
