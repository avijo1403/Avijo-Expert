...
export default function PersonnelInfoDoc({ navigation }) {
    ...
    const Info = () => {
        return (
            <View style={{ width: '100%', alignItems: 'center' }}>
                ...
                <View style={{ width: '92%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: '10%', marginRight: '1%', marginBottom: '5%' }}>
